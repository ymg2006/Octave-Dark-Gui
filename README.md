...
The editor and other colors should be configured from octave setting to achieve the screenshot result.
...
Already have sent patch request and it currently is committed so don't resubmit. https://savannah.gnu.org/patch/index.php?10201
